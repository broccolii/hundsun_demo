...
#import "HsPhotoProgressView.h"

@interface HsPhotoLoadingView ()
{
    UILabel *_failureLabel;
    HsPhotoProgressView *_progressView;
}

@end

@implementation HsPhotoLoadingView
...
- (void)showLoading
{
    ...
    if (_progressView == nil) {
        _progressView = [[HsPhotoProgressView alloc] init];
