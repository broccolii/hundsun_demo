...
#pragma  mark  王金东 增加
- (void)updateStylesheet:(NIStylesheet *)stylesheet{
    _stylesheet = stylesheet;
    [self refresh];
}
- (NICSSRuleset *)rulesetforClass:(NSString *)className{
    NICSSRuleset *ruleset = [_stylesheet rulesetForClassName:className];
    return  ruleset;
}
